...
import { t as createCsrfMiddleware } from "./createCsrfMiddleware-DTklzr3j.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-dl-_sIBQ.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-yLoyGVb2.mjs"),
		import("./start-Ds-7SBxW.mjs"),
