...
//#region node_modules/.nitro/vite/services/ssr/assets/schemes.functions-BMJryA7W.js
...
var getSchemeBySlug = createServerFn({ method: "GET" }).validator((input) => objectType({ slug: stringType() }).parse(input)).handler(getSchemeBySlug_createServerFn_handler, async ({ data }) => {
