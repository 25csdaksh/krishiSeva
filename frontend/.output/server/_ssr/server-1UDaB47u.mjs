...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DoAX-fYX.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DpqjrkM3.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BSNGZxEO.mjs"),
		import("./start-CzsfMzMF.mjs"),
