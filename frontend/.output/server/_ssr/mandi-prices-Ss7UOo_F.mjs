...
//#region node_modules/.nitro/vite/services/ssr/assets/mandi-prices-Ss7UOo_F.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var $$splitComponentImporter = () => import("./mandi-prices-yJponTy6.mjs");
var Route = createFileRoute("/_authenticated/mandi-prices")({
	head: () => ({ meta: [
...
//#endregion
export { Route as n, MandiPricesSection as t };
