...
//#region node_modules/.nitro/vite/services/ssr/assets/market.functions-CtO33n_9.js
...
var deleteMarketListing = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).validator((input) => objectType({ id: stringType() }).parse(input)).handler(deleteMarketListing_createServerFn_handler, async ({ data, context }) => {
