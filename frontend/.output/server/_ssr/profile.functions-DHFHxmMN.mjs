...
//#region node_modules/.nitro/vite/services/ssr/assets/profile.functions-DHFHxmMN.js
...
var completeOnboarding = createServerFn({ method: "POST" }).middleware([requireSupabaseAuth]).inputValidator((input) => objectType({
	full_name: stringType().nullable().optional(),
	phone: stringType().nullable().optional(),
	district: stringType().nullable().optional(),
	state: stringType().nullable().optional(),
